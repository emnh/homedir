...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/emh/.eclipse/org.eclipse.platform_3.2.0/configuration/eclipse/plugins/org.eclim_1.5.6'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/emh/.eclipse/org.eclipse.platform_3.2.0/configuration/eclipse'
  if has('win32unix')
